...
function getCityBuy(val){
	...
	newStr.push("<li onclick=\"getProvinceBuy()\" style=\"background-color:#808080; color: #FFFFFF;  \">"+province[val].NAME+"</li>");
...
function getAreaBuy(val,val1){
	...
	var newStr=new Array();
	newStr.push("<div class=\"dqld_div\"><ul>");
	newStr.push("<li onclick=\"getProvinceBuy()\" style=\"background-color:#999999; color: #FFFFFF; \">"+province[val1].NAME+"</li>");
	newStr.push("<li onclick=\"getCityBuy("+val1+")\" style=\"background-color:#ccc; color: #FFFFFF; padding-left:10px;\">"+city[val].NAME+"</li>");
